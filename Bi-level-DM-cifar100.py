...
from dc_utils import get_dataset, get_network, get_eval_pool, evaluate_synset, get_time, epoch, DiffAugment, TensorDataset, ParamDiffAug, parser_bool, number_sign_augment, downscale
import torchnet
    ...
    for exp in range(args.num_exp):
        ...
        for it in range(args.Iteration+1):
            ...
            for c in range(num_classes):
                ...
                prob = net(img_real_test)
                # out = net(img_real_test)
                # print("Error")
                # print(out)
                # print(type(out))
                # print(np.shape(out))
